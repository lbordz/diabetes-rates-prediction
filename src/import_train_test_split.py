...
#removing rows without diabetes 2013 info (= no target information)
merged_df = merged_df[merged_df['DB:2013:percent'].isnull() == False]

#removing duplicative columns
desired_merged_columns = ['State_master', 'FIPS_master', 'County_master', 'DB:2009:percent',
       'DB:2010:percent', 'DB:2013:percent', 'TOT_POP', 'TOT_MALE', 'WAC_MALE', 'WAC_FEMALE', 'BAC_MALE',
